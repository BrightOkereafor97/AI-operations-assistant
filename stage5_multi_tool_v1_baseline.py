...
# ================================================================
# STAGE 5 — V1 MULTI-TOOL BASELINE
#
# Goal:
# Allow one user request to select more than one tool.
#
# IMPORTANT:
# V1 does NOT yet pass one tool's output into the next tool.
# Dependent/chained requests are expected to expose this weakness.
# ================================================================
...
DETAIL_FILE = (
    RESULTS_DIR
    / "stage5_results_v1.csv"
)

SUMMARY_FILE = (
    RESULTS_DIR
    / "stage5_summary_v1.csv"
)
...
def parse_tool_plan(
    ...
    # ------------------------------------------------------------
    # If real tools were selected, ignore NO_TOOL.
    # ------------------------------------------------------------
...
# ================================================================
# 11. EXTRACT CALCULATION ARGUMENTS
# ================================================================
...
def extract_calculation_arguments(
    ...
    # ------------------------------------------------------------
    # Remove structured IDs first.
    #
    # Otherwise:
    #
    # TKT-005 could accidentally contribute 5
    # EXP-010 could accidentally contribute 10
    #
    # to the arithmetic.
    # ------------------------------------------------------------
...
def extract_argument(
    ...
    if tool_name == "search_company_knowledge":
        ...
        # V1 BASELINE:
        #
        # We pass the full user request to RAG.
        #
        # Later versions may extract only the relevant
...
# ================================================================
# 18. NORMALIZE FIRST ARGUMENT FOR EVALUATION
# ================================================================
...
def evaluate_request(
    ...
    # EXACT PLAN
    #
    # Correct tools AND correct order.
    # ------------------------------------------------------------
    ...
    #
    # How many expected tools were included?
    # ------------------------------------------------------------
    ...
    #
    # The Stage 5 CSV stores the expected argument
    # for the first required tool.
    # ------------------------------------------------------------
    ...
    # DEPENDENCY CHECK
    #
    # V1 does not yet pass output from one tool
    # into another.
    #
    # Independent requests therefore pass this
    # condition automatically.
    #
    # Dependent requests are marked False so the
    # baseline exposes the missing chaining ability.
    # ------------------------------------------------------------
