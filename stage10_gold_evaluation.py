...
def execute_system(
    ...
    # Only treat an explicit escalation ACTION as a write request.
    #
    # V1 used:
    #     "escalat" in user_request.lower()
    #
    # That also matched read-only phrases such as
    # "escalation policy" and "escalation process".
    #
    # V1.1 requires the actual action verb "escalate".
    if re.search(
        r"\bescalate\b",
        user_request,
        re.IGNORECASE
